...
/* -------------------------------------------------------------------------*/
void
calc_geom_thin(int disp_col, int new_col, double L, double h_h )
...
/* -------------------------------------------------------------------------*/
void
geom_thin(int disp_col, int gouge_thick_col, int new_col, double L)
...
/* -------------------------------------------------------------------------*/
void
vol_corr(int vs_c, int tau_c, int new_col, int first, int last, double SV_on_V)
